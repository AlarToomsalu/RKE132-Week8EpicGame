...
//string[] weapon = { "spoon", "rocket", "shovel", "raven", "book" };
...
Console.WriteLine($"Today {villain}({villainHP} HP) with {villainWepon} tries to takes over the world!");
...
Console.WriteLine($"Villain{villain}HP: {heroHP}");
if (heroHP > 0 )
{
